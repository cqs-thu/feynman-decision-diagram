...
ccz qubits[24],qubits[29],qubits[30];
...
ccz qubits[3],qubits[4],qubits[9];
...
ccz qubits[27],qubits[31],qubits[33];
ccz qubits[29],qubits[32],qubits[35];
ccz qubits[21],qubits[22],qubits[23];
ccz qubits[20],qubits[23],qubits[25];
ccz qubits[34],qubits[37],qubits[38];
...
ccz qubits[24],qubits[26],qubits[28];
ccz qubits[11],qubits[13],qubits[16];
ccz qubits[5],qubits[6],qubits[8];
ccz qubits[19],qubits[20],qubits[21];
ccz qubits[12],qubits[16],qubits[17];
ccz qubits[30],qubits[31],qubits[33];
ccz qubits[20],qubits[23],qubits[25];
