...
ccz qubits[21],qubits[22],qubits[27];
ccz qubits[6],qubits[8],qubits[11];
ccz qubits[11],qubits[14],qubits[16];
ccz qubits[10],qubits[11],qubits[16];
ccz qubits[34],qubits[38],qubits[39];
...
ccz qubits[26],qubits[30],qubits[31];
...
ccz qubits[23],qubits[25],qubits[28];
ccz qubits[18],qubits[21],qubits[23];
...
ccz qubits[25],qubits[27],qubits[30];
ccz qubits[33],qubits[35],qubits[38];
ccz qubits[32],qubits[35],qubits[38];
