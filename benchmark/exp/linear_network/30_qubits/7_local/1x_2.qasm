...
ccz qubits[19],qubits[22],qubits[25];
ccz qubits[21],qubits[22],qubits[26];
ccz qubits[0],qubits[2],qubits[3];
ccz qubits[2],qubits[4],qubits[7];
ccz qubits[20],qubits[21],qubits[22];
ccz qubits[8],qubits[11],qubits[12];
ccz qubits[17],qubits[19],qubits[22];
...
ccz qubits[15],qubits[17],qubits[20];
ccz qubits[4],qubits[5],qubits[6];
ccz qubits[5],qubits[8],qubits[10];
ccz qubits[8],qubits[12],qubits[14];
ccz qubits[14],qubits[19],qubits[20];
ccz qubits[9],qubits[10],qubits[15];
ccz qubits[11],qubits[12],qubits[15];
ccz qubits[3],qubits[5],qubits[6];
ccz qubits[0],qubits[2],qubits[6];
h qubits[0];
h qubits[1];
h qubits[2];
h qubits[3];
