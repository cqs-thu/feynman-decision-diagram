...
h qubits[22];
ccx qubits[19],qubits[20],qubits[22];
h qubits[19];
...
h qubits[26];
ccx qubits[23],qubits[24],qubits[26];
ccx qubits[23],qubits[24],qubits[25];
h qubits[25];
...
h qubits[25];
h qubits[26];
ccx qubits[24],qubits[26],qubits[28];
h qubits[24];
h qubits[27];
ccx qubits[25],qubits[26],qubits[29];
h qubits[25];
h qubits[26];